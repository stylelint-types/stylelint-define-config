...
import type { ColorNamedOptions } from './color-named'
import type { ColorNoHexOptions } from './color-no-hex'
import type { ColorNoInvalidHexOptions } from './color-no-invalid-hex'
import type { CommentEmptyLineBeforeOptions } from './comment-empty-line-before'
import type { CommentNoEmptyOptions } from './comment-no-empty'
...
import type { CustomPropertyPatternOptions } from './custom-property-pattern'
import type { DeclarationBlockNoDuplicateCustomPropertiesOptions } from './declaration-block-no-duplicate-custom-properties'
import type { DeclarationBlockNoDuplicatePropertiesOptions } from './declaration-block-no-duplicate-properties'
import type { DeclarationBlockNoRedundantLonghandPropertiesOptions } from './declaration-block-no-redundant-longhand-properties'
import type { DeclarationBlockNoShorthandPropertyOverridesOptions } from './declaration-block-no-shorthand-property-overrides'
import type { DeclarationBlockSingleLineMaxDeclarationsOptions } from './declaration-block-single-line-max-declarations'
import type { DeclarationEmptyLineBeforeOptions } from './declaration-empty-line-before'
import type { DeclarationNoImportantOptions } from './declaration-no-important'
import type { DeclarationPropertyMaxValuesOptions } from './declaration-property-max-values'
import type { DeclarationPropertyUnitAllowedListOptions } from './declaration-property-unit-allowed-list'
...
import type { FontWeightNotationOptions } from './font-weight-notation'
import type { FunctionAllowedListOptions } from './function-allowed-list'
import type { FunctionCalcNoUnspacedOperatorOptions } from './function-calc-no-unspaced-operator'
import type { FunctionDisallowedListOptions } from './function-disallowed-list'
import type { FunctionLinearGradientNoNonstandardDirectionOptions } from './function-linear-gradient-no-nonstandard-direction'
import type { FunctionNameCaseOptions } from './function-name-case'
import type { FunctionNoUnknownOptions } from './function-no-unknown'
import type { FunctionUrlNoSchemeRelativeOptions } from './function-url-no-scheme-relative'
import type { FunctionUrlQuotesOptions } from './function-url-quotes'
import type { FunctionUrlSchemeAllowedListOptions } from './function-url-scheme-allowed-list'
import type { FunctionUrlSchemeDisallowedListOptions } from './function-url-scheme-disallowed-list'
import type { HueDegreeNotationOptions } from './hue-degree-notation'
import type { ImportNotationOptions } from './import-notation'
import type { KeyframeBlockNoDuplicateSelectorsOptions } from './keyframe-block-no-duplicate-selectors'
...
import type { MediaFeatureNameNoUnknownOptions } from './media-feature-name-no-unknown'
import type { MediaFeatureNameNoVendorPrefixOptions } from './media-feature-name-no-vendor-prefix'
import type { MediaFeatureNameUnitAllowedListOptions } from './media-feature-name-unit-allowed-list'
import type { MediaFeatureNameValueAllowedListOptions } from './media-feature-name-value-allowed-list'
...
import type { SelectorAttributeOperatorAllowedListOptions } from './selector-attribute-operator-allowed-list'
import type { SelectorAttributeOperatorDisallowedListOptions } from './selector-attribute-operator-disallowed-list'
import type { SelectorAttributeQuotesOptions } from './selector-attribute-quotes'
import type { SelectorClassPatternOptions } from './selector-class-pattern'
import type { SelectorCombinatorAllowedListOptions } from './selector-combinator-allowed-list'
import type { SelectorCombinatorDisallowedListOptions } from './selector-combinator-disallowed-list'
import type { SelectorDisallowedListOptions } from './selector-disallowed-list'
import type { SelectorIdPatternOptions } from './selector-id-pattern'
import type { SelectorMaxAttributeOptions } from './selector-max-attribute'
import type { SelectorMaxClassOptions } from './selector-max-class'
import type { SelectorMaxCombinatorsOptions } from './selector-max-combinators'
import type { SelectorMaxCompoundSelectorsOptions } from './selector-max-compound-selectors'
import type { SelectorMaxIdOptions } from './selector-max-id'
import type { SelectorMaxPseudoClassOptions } from './selector-max-pseudo-class'
import type { SelectorMaxSpecificityOptions } from './selector-max-specificity'
...
import type { SelectorPseudoClassAllowedListOptions } from './selector-pseudo-class-allowed-list'
import type { SelectorPseudoClassDisallowedListOptions } from './selector-pseudo-class-disallowed-list'
import type { SelectorPseudoClassNoUnknownOptions } from './selector-pseudo-class-no-unknown'
import type { SelectorPseudoElementAllowedListOptions } from './selector-pseudo-element-allowed-list'
import type { SelectorPseudoElementColonNotationOptions } from './selector-pseudo-element-colon-notation'
import type { SelectorPseudoElementDisallowedListOptions } from './selector-pseudo-element-disallowed-list'
import type { SelectorPseudoElementNoUnknownOptions } from './selector-pseudo-element-no-unknown'
import type { SelectorTypeCaseOptions } from './selector-type-case'
